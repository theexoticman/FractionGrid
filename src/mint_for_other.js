...
// have to guess which interfaces are used to develop the nft contract.
// what happens if methods are missing
...
const mint = async () => {
  ...
  try {
    const result = await new web3.eth.Contract(
      nft_abi,
      "0xf9315c7AbBF9D2B7928c646Fe702f96275777863"
    ).methods
      .mint(
        accounts[0],
        "3",
        "https://ipfs.io/ipfs/QmY99sxUQRJ38W7SaSywHPM9QLtukfwJpJ7PaRpNvzu1T6?filename=why%20now.jpg"
      )
